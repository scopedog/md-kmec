...
#define RAIDKM_TARGET_RHEL10 1

/*
 * bitmap write tracking.  RHEL 10.2 dropped the write-behind/success
 * flags from bitmap_ops->startwrite/endwrite, so raidkm passes 3 args
 * here; the `ok` argument of the endwrite shim is unused on RHEL.
 */
